// Generated on 2013-12-28 using generator-angular-fullstack 1.0.1
'use strict';
...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    usemin: {
      ...
      index: ['<%= yeoman.views %>/index.html'],
      options: {
        assetsDirs: ['<%= yeoman.dist %>'],
        patterns: {
          js: [[/(data\.json)/, 'Replacing reference to data.json']],
          index: [[/(images\/screenshot\.jpg)/gm, 'Replacing reference to screenshot.jpg']]
        }
      }
    },
